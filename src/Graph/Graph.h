...
public:
    ...
    virtual void update_label(Node n, const Label& l) =0;
    virtual void update_weight(Node& from, Node& to, const Weight& w) =0;
...
//  virtual bool are_adjacents(Node from, Node to) const =0;
    ...
    virtual void DFS_visit(const Node& start_node) const =0;
    virtual void BFS_visit(const Node& start_node) const =0;
